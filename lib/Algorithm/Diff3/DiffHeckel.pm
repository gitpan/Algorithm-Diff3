package Algorithm::Diff3::DiffHeckel;
...
use base qw( Algorithm::Diff3::Base );
...
Algorithm::Diff3::DiffHeckel - P. Heckel's diff plugin
...
This is a package for Algorithm::Diff3 to compute difference
...
Algorithm::Diff3 needs a support of computing difference sets
...
for the diff computation, Algorithm::Diff3 makes a plan
independ on any specific diff routine. It calls a pluggable diff
processor instanse specifed in a factory commonly used in
Algorithm::Diff3. Anyone may change diff plugin according to
their text properties.

For users convenience, Algorithm::Diff3 includes small diff
...
Algorithm::Diff3::Factory is a class to packaging several classes
...
An already blessed instanse by Algorithm::Diff3::Text or an another the
